import type { TestExecution as DBTestExecution } from "./db/schema";
...
export class FlakyTestAnalyzer {
  analyze(executions: DBTestExecution[]): FlakyAnalysisResult {
  ...
  private calculateTimingVariance(executions: DBTestExecution[]): number {
  ...
  private calculateDOMStability(executions: DBTestExecution[]): number {
